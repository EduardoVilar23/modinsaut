...
MsgBox ("INSERIR IMAGENS - Antes de prosseguir, cerifique-se de que a pasta selecionada possua apenas as imagens e nenhum outro arquivo. As imagens devem ter os nomes no padrão -> (1), (2), (3), etc. tendo as extensões JPG ou JPEG. Atualizado em 01/05/2024")
